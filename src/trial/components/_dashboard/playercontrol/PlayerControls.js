    ...
    <ControlsWrapper>
      ...
      >
        <Grid item>
         ...
         <Grid container direction="row" alignItems="center" justifyContent="center" spacing={2} style={{marginTop:10}}>
            ...
            <Typography>{playbackRate}x</Typography>
              ...
              >
               ...
               <FullScreenbtn onClick={onToggleFullScreen}>
                  <L.O sx={{display:{xs:'none',sm:'block'}}}>
                      <L.FullScreenIcon fontSize="large" />
                  </L.O>
                  <L.O sx={{display:{xs:'block',sm:'none'}}}>
                      <L.FullScreenIcon fontSize="small" />
                  </L.O>
               </FullScreenbtn>
        </Grid>
      </Grid>
